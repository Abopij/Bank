...
## Дополнительно использовал redis из контейнера для кэша, lombok для удобства. Основной фрэймворк Spring Boot 3. В качастве бд использован был PostgreSQL. <u>Очень надеюсь на положительную оценку! :)</u> Jwt для авторизации. ##
...
Результат предоставить в виде публичного репозитория на github._"
